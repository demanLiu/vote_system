...
('501', 'Vote', '投票管理', 1497078419, 0, 1, 5, 'icon-flag');
...
(294, 'Votecate', '投票菜单', 1, '', 4, 1, 2, 0, 501, 'icon-instagram'),
...
(304, 'Vote', '投票列表', 1, '', 4, 1, 2, 0, 501, 'icon-magic'),
...
(500, 'Votemember', '投票选手', 1, '', 5, 1, 2, 0, 501, 'icon-sitemap');
...
(66, 'ACTIVIATIONID', 1, '激活的投票ID', 7, '', '投票活动的ID！', 1420975387, 1420975464, 1, '1', 2),
