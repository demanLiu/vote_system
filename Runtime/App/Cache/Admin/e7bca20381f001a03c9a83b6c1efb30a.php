<?php if (!defined('THINK_PATH')) exit();?>   <form action="<?php echo U('insert');?>" id="j_custom_form"  class=" form-validate col-md-12 form-label-right center-margin" method="post" noEnter>
